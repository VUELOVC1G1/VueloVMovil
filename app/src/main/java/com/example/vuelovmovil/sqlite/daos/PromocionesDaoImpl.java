...
import com.example.vuelovmovil.sqlite.contracts.PromocionContract;
...
public class PromocionesDaoImpl implements IEntityDao<Promocion, Long> {
    ...
    @Override
    public boolean save(Promocion promocion) {
